      ...
      <section className="relative bg-neutral-950 text-white overflow-hidden min-h-[90vh] flex items-center pt-24 pb-32">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <iframe 
            ...
            className="absolute top-1/2 left-1/2 w-[100vw] h-[56.25vw] min-h-[100vh] min-w-[177.77vh] -translate-x-1/2 -translate-y-1/2 opacity-[0.32] mix-blend-screen"
          ></iframe>
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-orange-950/[0.15] via-neutral-950/[0.75] to-neutral-950/[0.95]"></div>
        </div>
