    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative bg-black text-white py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Energetické štítky (PENB)</h1>
      ...
      {isBaseRoute ? (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h2 className="text-3xl font-bold text-black mb-6">Proč potřebujete energetický štítek?</h2>
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100">
              <h3 className="text-2xl font-bold text-black mb-6">Proč si vybrat Delphia Czech?</h3>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-black">Nejrychlejší v ČR do 48 hodin</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-black">Garantovaná nejnižší cena</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-black">Právní jistota a odbornost</h4>
          ...
          <h2 className="text-3xl font-bold text-black mb-8 text-center">Vyberte si kategorii budovy</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <Link to="/energeticke-stitky/rodinne-domy" className="group block bg-white rounded-2xl p-8 border border-slate-200 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-black mb-4 group-hover:text-orange-600 transition-colors">Rodinné domy</h3>
            ...
            <Link to="/energeticke-stitky/bytove-domy" className="group block bg-white rounded-2xl p-8 border border-slate-200 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-black mb-4 group-hover:text-orange-600 transition-colors">Bytové domy</h3>
              <p className="text-slate-600 mb-8 leading-relaxed">
            ...
            <Link to="/energeticke-stitky/ostatni-budovy" className="group block bg-white rounded-2xl p-8 border border-slate-200 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-black mb-4 group-hover:text-orange-600 transition-colors">Ostatní budovy</h3>
              <p className="text-slate-600 mb-8 leading-relaxed">
          ...
          <div className="bg-black rounded-3xl p-8 md:p-12 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
              ...
              <div className="relative z-10 text-center">
                <div className="w-16 h-16 mx-auto bg-orange-600 rounded-full flex items-center justify-center text-2xl font-bold mb-4 border-4 border-black">1</div>
              ...
              <div className="relative z-10 text-center">
                <div className="w-16 h-16 mx-auto bg-orange-600 rounded-full flex items-center justify-center text-2xl font-bold mb-4 border-4 border-black">2</div>
              ...
              <div className="relative z-10 text-center">
                <div className="w-16 h-16 mx-auto bg-orange-600 rounded-full flex items-center justify-center text-2xl font-bold mb-4 border-4 border-black">3</div>
              ...
              <div className="relative z-10 text-center">
                <div className="w-16 h-16 mx-auto bg-orange-600 rounded-full flex items-center justify-center text-2xl font-bold mb-4 border-4 border-black">4</div>
            ...
            <div className="mt-12 text-center">
              <Link to="/kontakty" className="inline-flex items-center bg-white text-black hover:bg-orange-50 px-8 py-4 rounded-lg font-semibold transition-colors">
