    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-neutral-950 mb-8 tracking-tighter">Energetické štítky pro <br className="hidden md:block"/>bytové komplexy.</h2>
          <p className="text-xl text-neutral-500 mb-10 font-medium leading-relaxed">
            Společenství vlastníků jednotek (SVJ) a bytovým družstvům dodáváme komplexní proces certifikace od zameření až po finální autorizaci.
          </p>
          
          <h3 className="text-2xl font-black text-neutral-950 mt-12 mb-6 tracking-tight">Kdy SVJ/Družstvo potřebuje PENB?</h3>
          <ul className="space-y-4 mb-12">
            {[
              'Při prodeji ucelené části budovy (bytu)',
              'Při pronájmu ucelené části budovy (bytu)',
              'Při dotacích a plánování revitalizace objektu',
              'Při zateplení fasády, revizi oken či pláště budovy',
              'Pro splnění plošné zákonné povinnosti domů'
            ].map((item, i) => (
          ...
          <div className="bg-neutral-50 rounded-[2.5rem] p-10 border border-neutral-200">
            <h3 className="text-2xl font-black text-neutral-950 mb-4 tracking-tight">Proč si vybrat nás?</h3>
            <p className="text-neutral-500 font-medium mb-6">Máme za sebou desítky panelových a komplexních zástaveb.</p>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-0">
              <li className="flex items-center font-bold text-neutral-700 bg-white px-4 py-3 rounded-xl border border-neutral-200 shadow-sm"><div className="w-2 h-2 bg-neutral-950 rounded-full mr-3"></div>Rozsáhlá praxe</li>
              <li className="flex items-center font-bold text-neutral-700 bg-white px-4 py-3 rounded-xl border border-neutral-200 shadow-sm"><div className="w-2 h-2 bg-neutral-950 rounded-full mr-3"></div>Osobní SVJ prezentace</li>
              <li className="flex items-center font-bold text-neutral-700 bg-white px-4 py-3 rounded-xl border border-neutral-200 shadow-sm"><div className="w-2 h-2 bg-neutral-950 rounded-full mr-3"></div>Dotační optimalizace</li>
              <li className="flex items-center font-bold text-neutral-700 bg-white px-4 py-3 rounded-xl border border-neutral-200 shadow-sm"><div className="w-2 h-2 bg-neutral-950 rounded-full mr-3"></div>Exkluzivní poradenství</li>
            </ul>
          </div>
        </motion.div>
            ...
            <div className="space-y-6 mb-12 relative z-10">
              ...
              <div className="flex items-center border-b border-white/10 pb-6">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">7 – 14 prac. dnů</p>
                </div>
              </div>
