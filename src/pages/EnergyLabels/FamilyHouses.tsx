    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-neutral-950 mb-8 tracking-tighter">Energetické štítky pro <br className="hidden md:block"/>rodinné domy.</h2>
          <p className="text-xl text-neutral-500 mb-10 font-medium leading-relaxed">
            Průkaz energetické náročnosti budovy (PENB) je pro rodinné domy legislativní nutností. Zpracujeme jej pro vás bleskově, s certifikovanými inženýry a bezkonkurenční cenou.
          </p>
          
          <h3 className="text-2xl font-black text-neutral-950 mt-12 mb-6 tracking-tight">Kdy PENB bezpodmínečně potřebujete?</h3>
          <ul className="space-y-4 mb-12">
            {[
              'Stavební povolení u novostavby',
              'Prodej rodinného domu',
              'Pronájem rodinného domu',
              'Rekonstrukce nad 25 % tepelné obálky budovy',
              'Zajištění dotace z projektu Nová zelená úsporám'
            ].map((item, i) => (
          ...
          <div className="bg-neutral-50 rounded-[2.5rem] p-10 border border-neutral-200">
            <h3 className="text-2xl font-black text-neutral-950 mb-4 tracking-tight">Potřebné podklady</h3>
            <p className="text-neutral-500 font-medium mb-6">Pro plynulé zpracování dodejte digitální nebo tištěnou projektovou dokumentaci:</p>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <li className="flex items-center font-bold text-neutral-700 bg-white px-4 py-3 rounded-xl border border-neutral-200 shadow-sm"><div className="w-2 h-2 bg-neutral-950 rounded-full mr-3"></div>Půdorysy podlaží</li>
              <li className="flex items-center font-bold text-neutral-700 bg-white px-4 py-3 rounded-xl border border-neutral-200 shadow-sm"><div className="w-2 h-2 bg-neutral-950 rounded-full mr-3"></div>Řezy budovou</li>
              <li className="flex items-center font-bold text-neutral-700 bg-white px-4 py-3 rounded-xl border border-neutral-200 shadow-sm"><div className="w-2 h-2 bg-neutral-950 rounded-full mr-3"></div>Pohledy fasád</li>
              <li className="flex items-center font-bold text-neutral-700 bg-white px-4 py-3 rounded-xl border border-neutral-200 shadow-sm"><div className="w-2 h-2 bg-neutral-950 rounded-full mr-3"></div>Technická zpráva (skladby)</li>
            </ul>
            <div className="flex items-start bg-orange-50 p-5 rounded-2xl border border-orange-100">
                <ShieldCheck className="w-6 h-6 text-orange-600 mr-4 shrink-0" />
                <p className="text-sm font-bold text-orange-900">
                    Nemáte dokumentaci? Náš technik provede expresní zaměření přímo na místě po celé ČR.
                </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="bg-neutral-950 rounded-[2.5rem] p-10 shadow-2xl sticky top-32 overflow-hidden relative">
            ...
            <div className="space-y-6 mb-12 relative z-10">
              <div className="flex items-center border-b border-white/10 pb-6">
                ...
                <div>
                  <p className="text-sm text-neutral-400 font-bold uppercase tracking-wider mb-1">Cena od</p>
                  <p className="text-3xl font-black text-white flex items-baseline">
                    4 500 Kč <span className="text-base font-medium text-neutral-500 ml-2">bez DPH</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center border-b border-white/10 pb-6">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">3 – 5 prac. dnů</p>
                </div>
              </div>
